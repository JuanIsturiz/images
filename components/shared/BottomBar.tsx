...
async function BottomBar() {
  ...
  return (
    <section>
      <div className="fixed bottom-0 z-40 flex w-full justify-between items-center gap-2 mt-2 px-12 py-2 bg-zinc-100 rounded rounded-b-none dark:bg-zinc-900 md:hidden">
        {sideLinks.map((link) => (
